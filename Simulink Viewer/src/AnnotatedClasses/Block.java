...
public class Block {
    ...
    public static int default_length = 35;
        ...
        if(properties != null){
            for(Property property : properties){
                if(property.getName().equals("Position")){
                    ...
                    this.center = new Point2D((Double.parseDouble(positions[0]) + Double.parseDouble(positions[2]))/2, (Double.parseDouble(positions[1]) + Double.parseDouble(positions[3]))/2);
                    break;
                }
            }
        }
